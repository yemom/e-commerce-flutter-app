...
void main() {
  group('ProductListScreen', () {
    testWidgets('renders products, branch filter, and category filter', (
      ...
      expect(find.byKey(const Key('product-list.category.__all__')), findsOneWidget);
      ...
      await tester.tap(find.byKey(const Key('product-list.category.__all__')));
      await tester.pump();
      ...
      expect(selectedBranchId, isNull);
    });
